...
namespace Sunbox.Avatars {
    ...
    public class AvatarCustomization : MonoBehaviour {
        ...
        [AvatarFloatFieldAttribute("Eyes Size", "eyesSize", 0, 100, Section = SECTION_FACE_PARAMETERS)]
        ...
        {
            return CurrentGenderSkinnedRenderer.sharedMaterials[Constants.SKIN_MATERIAL_SLOT];
        }
